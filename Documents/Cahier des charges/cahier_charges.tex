...
\vspace*{0.5cm}
		...
		\subsection{Mode classique}
		    ...
		    Le mode classique est un mode permettant au joueur de compléter des grilles de tailles variées, allant de 5x5 à 25x25, et de difficultés croissantes, plus le joueur progresse dans le jeu.
