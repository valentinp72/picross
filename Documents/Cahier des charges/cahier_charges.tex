...
\chapter{Spécification des besoins}
		...
		\section{Didacticiel}
			Un niveau de l'application est présent comme didacticiel. Ce niveau est optionnel et permet aux joueurs débutants de se familiariser avec les règles du \textit{picross}. Il consiste en une partie guidée d'une grille simple de \textit{picross} en expliquant au joueur les actions à réaliser étape par étape afin de finir la grille. L'application contient également un rappel des règles générales du \textit{picross}.
